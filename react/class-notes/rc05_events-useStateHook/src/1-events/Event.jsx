...
const Events = () => {
  ...
  return (
    <div className="text-center mt-5 p-2">
      ...
      <button className="btn btn-dark me-5 rounded-start-pill" onClick={handleClick}>Click</button>
      ...
      <button className="btn btn-warning ms-5 rounded-end-pill" onClick={()=> alert("deneme")}>Save</button>
    </div>
  )
}

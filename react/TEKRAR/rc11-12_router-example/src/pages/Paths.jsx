...
const Paths = () => {
  ...
  return (
    <div className="container mt-4">
      ...
      <p className="fs-5">
        Join outstanding companies  with rewarding salaries. We offer the highest-demand IT skills you need for success! CHOOSE THE BEST COURSE 
      ...
      <div>
        ...
        <Link to="aws" className="btn btn-warning w-50">AWS_DevOps</Link>
      </div>
      <Outlet/>
    </div>
  )

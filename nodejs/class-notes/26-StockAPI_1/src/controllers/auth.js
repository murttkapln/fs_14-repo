...
module.exports = {
        ...
        if ((username || email) && password) {
            ...
            if (user && user.password == passwordEncrypt(password)) {
                ...
                if (user.is_active) {
                    ...
                    // JWT:
                    // const accessToken = jwt.sign(user.toJSON(), (process.env.ACCESS_KEY + user.password), { expiresIn: '30m' })
    ...
    logout: async (req, res) => {
        ...
        */
        ...
        const auth = req.headers?.authorization || null // Token ...tokenKey... / Bearer ...tokenKey...
        const tokenKey = auth ? auth.split(' ') : null // ['Token', '...tokenKey...'] / ['Bearer', '...tokenKey...']

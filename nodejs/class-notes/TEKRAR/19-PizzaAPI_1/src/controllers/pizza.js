...
module.exports = {
  ...
  update: async (req, res) => {
    ...
    */
    const data = await Pizza.updateOne({ _id: req.params.id }, req.body); // 1. parametre güncellenecek olan kaydı verir. 2. parametre ise güncellenmek üzere olan veriyi tanımlar.
    res.status(202).send({
      error: false,
      data,

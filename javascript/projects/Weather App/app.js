...
// ! 2.yöntem innerHtml ile oluşturduğumuz html kalıbını bacdick ile açarak dolar süslü ile api'deki verileri buraya ekledik.
  ...
  <div class="hava-nasil mt-3">
    ...
    <li class="list-group-item">
        <div class="div">
              <p class="hava-durumu-derece"> <span id="hissedilen-derece" class="h1 text-warning"> ${description} </span></p>
       </div>
    </li>
  </ul>
  
  <div class="card-body d-flex justify-content-between border  p-4  bg-light">
